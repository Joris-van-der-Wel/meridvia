...
| options.clear             | function(params, options) | __required__ | The [__`clear`__ callback](#clear-callback) for this __resource__. Called whenever asynchronous data that has been previously retrieved, is no longer in use. |
